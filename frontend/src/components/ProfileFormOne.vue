    ...
    <div>
        <form class="">
                ...
                <div class="w-full mb-3 sm:mb-5">
                    ...
                    <input type="text" v-model="salary" placeholder="Enter your current salary here" class="w-full text-brand-gray-light p-2 mt-1 sm:mt-3 border focus:outline-none border-black">
